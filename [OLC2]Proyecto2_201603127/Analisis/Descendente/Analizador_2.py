...
from Analisis.Descendente.ply import lex
...
def p_instrucciones_p(t):
    '''instrucciones_p : instruccion instrucciones_p'''
    t[2].insert(0,t[1])
    t[0] = t[2]

def p_instrucciones_pv(t):
    '''instrucciones_p : '''
    t[0] = []
...
def p_operaciones(t):
    '''operaciones : val operaciones_p'''
    t[0] = t[2]

def p_operaciones_p(t):
    '''operaciones_p :  MAS val
                     | MENOS val
                     | POR val
                     | DIVICION val
                     | RESIDUO val
                     ...
                     | MENOR val'''
    if t[1] == '+':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Aritmetica.SUMA, t[2].fila, t[2].columna)
    elif t[1] == '-':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Aritmetica.RESTA, t[2].fila, t[2].columna)
    elif t[1] == '*':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Aritmetica.POR, t[2].fila, t[2].columna)
    elif t[1] == '/':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Aritmetica.DIVICION, t[2].fila, t[2].columna)
    elif t[1] == '%':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Aritmetica.RESIDUIO, t[2].fila, t[2].columna)
    elif t[1] == '&&':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.AND, t[2].fila, t[2].columna)
    elif t[1] == '||':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.OR, t[2].fila, t[2].columna)
    elif str(t[1]).lower() == 'xor':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.XOR, t[2].fila, t[2].columna)
    elif t[1] == '&':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Bit.AND, t[2].fila, t[2].columna)
    elif t[1] == '|':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Bit.OR, t[2].fila, t[2].columna)
    elif t[1] == '^':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Bit.XOR, t[2].fila, t[2].columna)
    elif t[1] == '<<':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Bit.SHIFTI, t[2].fila, t[2].columna)
    elif t[1] == '>>':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Bit.SHIFTD, t[2].fila, t[2].columna)
    elif t[1] == '==':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.IGUAL_IGUAL, t[2].fila, t[2].columna)
    elif t[1] == '!=':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.DIFERENTE, t[2].fila, t[2].columna)
    elif t[1] == '>=':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.MAYOR_IGUAL, t[2].fila, t[2].columna)
    elif t[1] == '<=':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.MENOR_IGUAL, t[2].fila, t[2].columna)
    elif t[1] == '>':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.MAYOR, t[2].fila, t[2].columna)
    elif t[1] == '<':
        t[0] = Operacion_Binaria(t[-1], t[2], Operacion_Logica.MENOR, t[2].fila, t[2].columna)
...
def p_indices(t):
    '''indices : indice indices_P'''
    t[2].insert(0, t[1])
    t[0] = t[2]

def p_indices_p(t):
    '''indices_P : indice indices_P'''
    t[2].insert(0, t[1])
    t[0] = t[2]
...
from Analisis.Descendente.ply import yacc as yacc
parser = yacc.yacc()
